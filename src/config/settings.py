"""Application configuration for Risk Assessment Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="risk-assessment-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/risk_assessment_agent",
    ...
    opensearch_index: str = Field(default="risk_assessment_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="risk-assessment-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="risk-assessment-agent", description="A2A agent ID")
