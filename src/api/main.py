"""Risk Assessment Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Enterprise risk assessment agent that identifies cyber risks, calculates risk scores using FAIR methodology, maps risks to business impact, generates risk registers, and produces board-level risk reports.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
